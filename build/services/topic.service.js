        ...
        this.store = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = this.body.name;
                        topic = new Topic_1.default({ name: name });
        ...
        this.show = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = this.params.id;
                        return [4 /*yield*/, Topic_1.default.findOne({ _id: id })];
                    case 1:
                        topic = _a.sent();
                        return [2 /*return*/, topic];
                }
        ...
        this.update = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = this.params.id;
                        return [4 /*yield*/, Topic_1.default.findOneAndUpdate({ _id: id }, { $set: this.body })];
                    case 1:
                        topic = _a.sent();
                        return [2 /*return*/, topic];
                }
        ...
        this.destroy = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = this.params.id;
                        return [4 /*yield*/, Topic_1.default.findOneAndDelete({ _id: id })];
                    case 1:
                        topic = _a.sent();
                        return [2 /*return*/, topic];
                }
