...
var authController = /** @class */ (function () {
    function authController() {
        ...
        this.signup = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, username, email, password, hashedPassword, user;
        ...
        this.signin = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, user, compare, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, authentication_1.default.passwordCompare(password, user.password)];
                    case 2:
                        compare = _b.sent();
                        if (!compare) {
                            return [2 /*return*/, res.status(422).send({
                        ...
                        token = authentication_1.default.generateToken(user.id, user.username, user.password);
                        return [2 /*return*/, res.send({
                                status: res.statusCode,
                                success: true,
